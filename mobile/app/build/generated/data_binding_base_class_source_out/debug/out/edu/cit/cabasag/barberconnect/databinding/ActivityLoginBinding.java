...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull NestedScrollView rootView,
      ...
      @NonNull TextView tvError, @NonNull TextView tvSignUp, @NonNull TextView tvSuccess) {
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((NestedScrollView) rootView, btnGoogleLogin, btnLogin,
          etEmail, etPassword, tilEmail, tilPassword, tvError, tvSignUp, tvSuccess);
    }
